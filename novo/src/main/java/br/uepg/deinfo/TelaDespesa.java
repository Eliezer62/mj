...
public class TelaDespesa implements Tela
{

    private Window janela;
    private JPanel tela;

    TelaDespesa(Window janela)
    {
        this.janela = janela;
        tela = new JPanel();
        tela.setLayout(null);
        ...
        bt_salvar.addActionListener(e ->ManterDespesas.SalvarDespesa(campo_valor.getText().toString(), campo_descricao.getText()));
        tela.add(bt_salvar);
